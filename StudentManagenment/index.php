...
<body>
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right animate slideIn" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="customer-login.php">Customer Detalis</a>
           </div>
        </li>
      </ul>
    </div>
    ...
    <div class="container text-center  ">
        <h2 class="text-white font-weight-light">Welcome To</h2>
        <h1 class="lead text-white-50 display-1">Jagdish Provision Stores</h1>
    </div>
